...
public class TestUnitaire {
    ...
    public void setUp() {
        ...
        moniteur = new Moniteur("4812", "Ariel", "sirène", "Castres", "006793000", Calendar.getInstance(), 4);
        club = new Club(moniteur, "clubBleu", "1178439");
        site = new Site("Cannes", "rien");
        plongee = new Plongee(site, moniteur, Calendar.getInstance(), 20, 10);
        embauche = new Embauche(Calendar.getInstance(), moniteur, club);
        plongeur = new Plongeur("33", "Poisson", "Polochon", "Castres", "265749322", Calendar.getInstance(), 6, 5);
        plongeur2 = new Plongeur("34", "Crabe", "Sébastien", "Castres", "36573922", Calendar.getInstance(), 7, 8);
